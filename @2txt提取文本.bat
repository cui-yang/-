...
echo ------------------------------------------------------------
echo 请将需要提取的txt文件放入txt文件夹中，
echo ------------------------------------------------------------
echo 然后打开txt文件夹中任意一个文本，
echo ------------------------------------------------------------
echo 将所要提取的字符串所在的整行, 
echo ------------------------------------------------------------
...
:SCJL
del "%~dp0tool\txt指定行关键词.txt">nul 2>nul

:BSC
findstr /V /c:"ECHO " "tmp.txt">>"txt指定行关键词.txt"
gawk "!x[$0]++" "txt指定行关键词.txt" > "%~dp0tmp0.txt"
